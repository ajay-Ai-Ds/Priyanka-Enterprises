...
const faqs = [
  {
    q: "How much do safety nets cost in Hyderabad?",
    a: "The price of safety nets in Hyderabad starts from ₹12 to ₹35 per square foot. The exact rate depends on the mesh thickness, brand (like Garware), UV stabilization levels, and warranty period chosen (ranging from 1 to 5 years)."
  },
  {
  ...
  },
  {
    ...
    a: "Yes, Priyanka Enterprises offers a 100% free site inspection, measurement check, and cost estimation anywhere in Hyderabad. There are no hidden call-out fees or charges if you choose not to proceed."
  },
  {
    q: "Is same-day installation available in Hyderabad?",
    a: "Yes, we offer same-day inspection and installation services across Hyderabad. If you book an inspection before 12 PM, we can complete the installation on the same day."
  },
  {
  ...
  {
    q: "What areas in Hyderabad do you service?",
    a: "We service all locations in Hyderabad, including Manikonda, Hafeezpet, Gachibowli, Kondapur, Kokapet, Tellapur, Nallagandla, Miyapur, Madhapur, Jubilee Hills, Banjara Hills, Kukatpally, and surrounding suburbs."
  }
];
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <p className="text-slate-600 mt-3 text-sm sm:text-base">
            Read through our top 10 detailed FAQs to learn everything about installation, durability, and cost in Hyderabad.
          </p>
        ...
        <div className="text-center mt-12 bg-white rounded-2xl p-6 border border-slate-200 shadow-sm">
          ...
          >
            ...
            <span className="underline">+91 81214 88961</span>
          </a>
        </div>
