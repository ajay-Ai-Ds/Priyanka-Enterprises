    ...
    <>
      ...
      <div className="fixed bottom-24 right-5 z-40 flex flex-col space-y-3 items-end">
        ...
        <motion.a
          ...
          whileTap={{ scale: 0.9 }}
          className="flex items-center justify-center w-14 h-14 bg-accent hover:bg-accent-dark text-slate-900 rounded-full shadow-lg cursor-pointer transition-colors duration-200 animate-pulse-subtle relative group"
