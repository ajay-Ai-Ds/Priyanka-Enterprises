        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          ...
          <div>
            ...
            <p className="text-slate-400 text-sm leading-relaxed mb-6">
              {"Hyderabad's trusted safety net installation experts. Protecting your family, balcony, pets, and children with 100% premium, UV-resistant, long-lasting materials."}
            </p>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
              ...
              <li className="flex items-center space-x-2">
                ...
                <a href="tel:+918121488961" className="hover:text-white transition-colors font-semibold">
                  +91 81214 88961
                </a>
                <span className="text-slate-500">/</span>
                <a href="tel:+919963217077" className="hover:text-white transition-colors font-semibold">
                  +91 99632 17077
                </a>
              </li>
              <li className="flex items-center space-x-2">
                <Mail className="w-4 h-4 text-primary-light shrink-0" />
                <a href="mailto:Enterprisespriyanka564@gmail.com" className="hover:text-white transition-colors">
