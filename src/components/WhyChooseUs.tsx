        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-5 space-y-6">
            ...
            <h2 className="text-3xl sm:text-4xl font-extrabold font-display leading-tight">
              {"Why Priyanka Enterprises is Hyderabad's #1 Choice"}
            </h2>
            <p className="text-slate-300 text-sm sm:text-base leading-relaxed">
              {"We don't believe in cheap temporary fixes. At Priyanka Enterprises, we use marine-grade stainless steel wire ropes, 100% pure virgin HDPE netting, and heavy double-walled anchor expansions. Your family's safety is our highest priority."}
            </p>
