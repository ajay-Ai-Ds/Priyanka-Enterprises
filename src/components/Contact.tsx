...
export default function Contact() {
  ...
  const whatsappUrl = "https://wa.me/918121488961?text=Hi%20Priyanka%20Enterprises%2C%20I%20want%20to%20get%20in%20touch%20with%20you%20for%20safety%20net%20installation.";
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <p className="text-slate-600 mt-3 text-sm sm:text-base">
            Get in touch with us via phone, WhatsApp, or the enquiry form. We serve all areas in Hyderabad.
          </p>
          ...
          <div className="lg:col-span-6 space-y-8">
            <div className="space-y-6">
              <h3 className="text-2xl font-bold text-slate-800 font-display">
                Priyanka Enterprises Head Office
              </h3>
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className="w-full px-3.5 py-2.5 bg-white border border-slate-200 rounded-lg text-[16px] focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary transition-all"
                    />
                  </div>
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      className="w-full px-3.5 py-2.5 bg-white border border-slate-200 rounded-lg text-[16px] focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary transition-all resize-none"
                    />
                  </div>
