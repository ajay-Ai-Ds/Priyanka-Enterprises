...
const reviews = [
  {
    ...
    rating: 5,
    date: "1 week ago",
    text: "Excellent service from Priyanka Enterprises. I called them in the morning for bird nets in my balcony. Their team came by 2 PM, measured, quoted, and finished the installation by 4:30 PM. Very professional work and high quality nets."
  },
  {
    name: "Priyanka Nair",
  ...
  },
  {
    ...
    rating: 5,
    date: "1 month ago",
    text: "Best safety net services in Hyderabad. The pricing is very reasonable compared to others. They used high-quality, thick UV-resistant nets for pigeon protection. Very polite team."
  },
  {
    name: "Vikram Reddy",
    ...
    rating: 5,
    date: "1 month ago",
    text: "Priyanka team installed monkey safety nets in our apartment. The nets are very thick and strong, and monkey intrusions have completely stopped. Best investment. Fast and clean installation."
  },
  {
    name: "Shweta K.",
  ...
  },
  {
    ...
    rating: 5,
    date: "3 months ago",
    text: "Priyanka Enterprises is the best in Hyderabad. Prompt service, transparent rates, and highly durable nets. We had pigeon issues for years, now it is completely resolved."
  },
  {
    name: "Sunil Murthy",
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <p className="text-slate-600 mt-3 text-sm sm:text-base">
            Read real feedback from homeowners across Hyderabad who secured their spaces with us.
          </p>
