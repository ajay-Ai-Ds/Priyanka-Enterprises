    ...
    items: [
      {
        ...
        description: "The ultimate modern replacement for bulky iron grills. Made from Marine Grade 316 Stainless Steel cables coated with nylon, these thin invisible grills provide full safety for kids and pets while maintaining an open, luxurious view of Hyderabad."
      },
      {
        id: "window-grills",
...
export default function Services() {
  ...
  const whatsappUrl = (serviceName: string) =>
    `https://wa.me/918121488961?text=${encodeURIComponent(
      `Hello Priyanka Enterprises, I’m looking to secure my balcony with safety nets (${serviceName}). Could you please schedule a free site inspection at your earliest convenience? Let me know the available slots.`
    )}`;
